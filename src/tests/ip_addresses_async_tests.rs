...
mod ip_client_tests {
    ...
    async fn test_ip_client_get_with_relationships() {
        ...
        let result = mock_client
            .client()
            .ip_addresses()
            .get_with_relationships("8.8.8.8", &["urls"])
            .await;
...
mod ip_relationship_tests {
    ...
    test_ip_relationship!(
        test_ip_get_resolutions,
        get_resolutions,
        "/ip_addresses/8.8.8.8/resolutions"
    );
}
...
mod ip_file_relationship_tests {
    ...
    test_ip_relationship!(
        test_ip_get_communicating_files,
        get_communicating_files,
        "/ip_addresses/8.8.8.8/communicating_files"
    );
    test_ip_relationship!(
        test_ip_get_downloaded_files,
        get_downloaded_files,
        "/ip_addresses/8.8.8.8/downloaded_files"
    );
    test_ip_relationship!(
        test_ip_get_referrer_files,
        get_referrer_files,
        "/ip_addresses/8.8.8.8/referrer_files"
    );
}
